...
import instagraphlite.models.dto.PostRootSeedDto;
import instagraphlite.models.entity.Post;
import instagraphlite.repository.PostRepository;
import instagraphlite.service.PictureService;
import instagraphlite.service.PostService;
import instagraphlite.service.UserService;
import instagraphlite.util.ValidationUtil;
import instagraphlite.util.XmlParser;
...
public class PostServiceImpl implements PostService {
    ...
    public String importPosts() throws IOException, JAXBException {
        ...
        xmlParser.fromFile(POST_FILE_PATH, PostRootSeedDto.class).getPosts().stream()
                .filter(postSeedDto -> {
                    ...
                    stringBuilder.append(isValid ? "Successfully imported Post, made by " + postSeedDto.getUser().getUsername()
